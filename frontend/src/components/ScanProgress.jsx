...
export default function ScanProgress({ isScanning, progress, phase, statusMessage, scannedFiles, totalFiles }) {
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <PhaseBar
          label="Torrents"
          fillPct={torrentsFill}
          pulse={torrentsPulse}
          phaseStatus={torrentsStatus}
        />
        <PhaseBar
          label="Disk"
          fillPct={diskFill}
          pulse={false}
          phaseStatus={diskStatus}
        />
