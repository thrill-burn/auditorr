...
export default function Dashboard({ data, changes, onNavigate, isRefreshing }) {
  ...
  const metrics = [
    ...
    },
    {
      ...
      sub: `${formatBytes(det.orphaned_torrent_size)} of ${formatBytes(det.or_limit)} threshold`,
    ...
    },
    {
      ...
      sub: `${formatBytes(det.not_imported_size)} of ${formatBytes(det.ni_limit)} threshold`,
    ...
    },
    {
      ...
      sub: `${formatBytes(det.duplicate_size)} of ${formatBytes(det.dup_limit)} threshold`,
