    ...
    <div style={{ padding: 28 }}>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 16 }}>
        ...
        <ActionCard
          ...
          description={'Filter the Media explorer by "Orphaned", then click the Sonarr or Radarr pill buttons on any file row. auditorr will open that title directly in Sonarr/Radarr where you can run Interactive Search to find and grab a seeding version from your preferred tracker.'}
